...
public class SHorarioProfesor {
    ...
    public List<MHorarioProfesor> consultaPorNombre(String materia) throws Exception {
        try {
...
, MHorarioProfesor mHorarioProfesor) throws Exception {
        try {
            ...
            if (registroEncontrado.isPresent()) {
                ...
                nuevoRegistro.setMateria(mHorarioProfesor.getMateria());
                nuevoRegistro.setFechaInicio(mHorarioProfesor.getFechaInicio());
                nuevoRegistro.setFechaFinalizacion(mHorarioProfesor.getFechaFinalizacion());
                nuevoRegistro.setInstituto(mHorarioProfesor.getInstituto());
                nuevoRegistro.setHoraInicio(mHorarioProfesor.getHoraInicio());
                nuevoRegistro.setHoraFin(mHorarioProfesor.getHoraFin());
    ...
    public boolean eliminarHorario(String id_HorarioProfesor) throws Exception {
        try {
            Optional<MHorarioProfesor> registroEncontrado = iHorarioProfesor.findById(id_HorarioProfesor);
            if (registroEncontrado.isPresent()) {
    ...
    public MCliente anularHorario(String id_HorarioProfesor, MCliente mCliente) throws Exception {
        try{
            Optional<MHorarioProfesor> registroEncontrado=iHorarioProfesor.findById(id_HorarioProfesor);
            if(registroEncontrado.isPresent()) {
                MHorarioProfesor nuevoRegistro=registroEncontrado.get();
